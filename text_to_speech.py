...
# icon 
image_icon = PhotoImage(file="index.png")
...
gender_combox = Combobox(root,values=['Male','Female'],font="arial 14",state='r',width=10)
gender_combox.place(x=550,y=200)
...
imageicon = PhotoImage(file='index.png')
btn= Button(root,text="Speak",compound=LEFT,image=imageicon,width=130,font="arial 14 bold",command=speaknow)
btn.place(x=550,y=280)

imageicon2 = PhotoImage(file='dwn.png')
save= Button(root,text="Download",compound=LEFT,image=imageicon2,width=130,bg="#39c790",font="arial 14 bold",command=download)
